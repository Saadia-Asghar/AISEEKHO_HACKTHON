...
export default function PaymentScreen() {
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.muted}>{result.recommended.name} · {result.intent.service_label}</Text>
      ...
      <Pressable style={[styles.button, loading && styles.buttonDisabled]} onPress={onPay} disabled={loading}>
        {loading ? <ActivityIndicator color={colors.bg} /> : <Text style={styles.buttonText}>Pay & send confirmations</Text>}
      </Pressable>
