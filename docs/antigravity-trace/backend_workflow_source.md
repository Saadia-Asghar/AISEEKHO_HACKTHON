# KhidmatAI Antigravity node registration (source)

File: backend/app/antigravity/workflow.py
...
# PRD Â§4.2 â€” six Antigravity workflow nodes
...
def workflow_definition() -> dict[str, Any]:
    return {
        ...
        "orchestration_engine": ORCHESTRATION_ENGINE,
        "product": "KhidmatAI",
        "challenge": "Google Antigravity Hackathon 2026 â€” Challenge 2",
        "nodes": ANTIGRAVITY_NODES,
        "state_transitions": [
            "PENDING â†’ CONFIRMED â†’ REMINDER_SCHEDULED â†’ COMPLETED",
        ],
    }
```
